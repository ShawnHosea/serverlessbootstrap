...
exports.handler = async function Index (req) {
  ...
  let body = Layout({ 
    ...
    `<div class="main">
      ...
      <p>Serverless architecture empowers the solo developer to <strong>build & iterate</strong> with immense <strong>speed & scalability</strong> while keeping costs low.</p>
      <ul>
